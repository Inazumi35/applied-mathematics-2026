...
$\mathcal{L}^{-1} = e^{-t}\!\left(2\cos 2t - \dfrac{1}{2}\sin 2t\right)$
}
...
$x(t) = e^{-t}\!\left(\cos 2t + \dfrac{3}{2}\sin 2t\right)$
...
\kotae{
$(s^2+4)Y = X$ より $H(s) = \dfrac{1}{s^2+4}$

$h(t) = \dfrac{1}{2}\sin 2t$
