...
$f(x) = -\dfrac{\pi}{4} + \displaystyle\sum_{n=1}^{\infty}\left[\dfrac{1-(-1)^n}{n^2\pi}\cos nx + \dfrac{(-1)^{n+1}}{n}\sin nx\right]$
}
...
$f(x) = \dfrac{3}{4} + \displaystyle\sum_{n=1}^{\infty}\dfrac{(-1)^n-1}{n\pi}\sin n\pi x$
...
$1 = -\dfrac{1}{2}+\dfrac{6}{\pi}\!\left(1-\dfrac{1}{3}+\dfrac{1}{5}-\cdots\right)$
...
部分積分して $= \dfrac{2}{iu}+\dfrac{e^{-2iu}-1}{u^2}$

整理して $= \dfrac{e^{-2iu}-1-2iu}{u^2}$
