...
$\bigl[e^{(1-2in)x}\bigr]_{-\pi/2}^{\pi/2} = (-1)^n(e^{\pi/2}-e^{-\pi/2})$，\\[4pt]
$c_n = \dfrac{(-1)^n(e^{\pi/2}-e^{-\pi/2})}{\pi(1-2in)}$．
分母有理化 $\left(\cdot\dfrac{1+2in}{1+2in}\right)$：
\[
  c_n = \dfrac{(-1)^n(1+2in)(e^{\pi/2}-e^{-\pi/2})}{\pi(1+4n^2)}
\]
\[
  f(x) = \frac{e^{\pi/2}-e^{-\pi/2}}{\pi}
    \sum_{n=-\infty}^{\infty} \frac{(-1)^n(1+2in)}{1+4n^2}\,e^{2inx}
\]
}
