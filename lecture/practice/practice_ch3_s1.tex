...
\]
(2) 周期 $2,\ l=1$．奇関数なので $a_n=0$．\\[2pt]
$b_n = 2\displaystyle\int_0^1 x\sin n\pi x\,dx$：$u=x,\;dv=\sin n\pi x\,dx$ より\\[2pt]
$= 2\!\left\{\!\left[-\dfrac{x\cos n\pi x}{n\pi}\right]_0^1\!
  + \dfrac{1}{n\pi}\!\int_0^1\!\cos n\pi x\,dx\right\}$\\[2pt]
$= 2\!\left\{-\dfrac{(-1)^n}{n\pi}+0\right\} = \dfrac{2(-1)^{n+1}}{n\pi}$．
\[
...
\]
$e^{(1-2in)\pi/2} = e^{\pi/2}\cdot e^{-in\pi} = (-1)^n e^{\pi/2}$，\\[2pt]
$e^{-(1-2in)\pi/2} = e^{-\pi/2}\cdot e^{in\pi} = (-1)^n e^{-\pi/2}$ より\\[2pt]
$\bigl[e^{(1-2in)x}\bigr]_{-\pi/2}^{\pi/2}
  = (-1)^n(e^{\pi/2}-e^{-\pi/2}) = 2(-1)^n\sinh\dfrac{\pi}{2}$．\\[4pt]
よって
\[
