...
(4) $\dfrac{d^2x}{dt^2} + x = 2\sin 2t$ \quad （$x(0)=0,\ x'(0)=0$）
}
\kotae{
...
\]
(4) $(s^2+1)X = 4/(s^2+4)$．
$\dfrac{4}{(s^2+1)(s^2+4)} = \dfrac{4/3}{s^2+1} - \dfrac{4/3}{s^2+4}$．
\[
  x(t) = \dfrac{4}{3}\sin t - \dfrac{2}{3}\sin 2t
\]
}
...
\[
  y(t) = \dfrac{1}{6} - \dfrac{1}{2}e^{2t} + \dfrac{1}{3}e^{3t}
\]
(4) $X(s)=1/(s+1)$ より
$Y = \dfrac{1}{(s+1)(s-2)(s-3)} = \dfrac{1/12}{s+1} - \dfrac{1/3}{s-2} + \dfrac{1/4}{s-3}$．
\[
  y(t) = \dfrac{1}{12}e^{-t} - \dfrac{1}{3}e^{2t} + \dfrac{1}{4}e^{3t}
\]
}
