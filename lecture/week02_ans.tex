...
\begin{frame}{例題8　解答}
  ...
  \\[8pt]\textcolor{red}{\textbf{答}}：$L[e^{\alpha t}\sin(\mu t)] = \mu/((s-\alpha)^{2}+\mu^{2}) \ (s > \alpha)$
\end{frame}
...
\begin{frame}{問8　解答}
  ...
  \\[8pt]\textcolor{red}{\textbf{答}}：$L[\cos(\omega t)] = s/(s^{2}+\omega^{2}) \ (s > 0)$
\end{frame}
...
\begin{frame}{問10　解答}
  ...
  \\[8pt]\textcolor{red}{\textbf{答}}：$L[e^{\mu t}\cos(\mu t)] = (s-\mu)/((s-\mu)^{2}+\mu^{2})$
\end{frame}
