...
\begin{frame}{問7(1)　解答}
  ...
  \\[8pt]\hfill $\mathcal{F}[xe^{-x^{2}/2}] = -i\sqrt{2\pi}\,u\,e^{-u^{2}/2}$
\end{frame}
...
\begin{frame}{問7(2)　解答}
  ...
  \\[8pt]\hfill $\mathcal{F}[x^{2}e^{-x^{2}/2}] = \sqrt{2\pi}(1-u^{2})\,e^{-u^{2}/2}$
\end{frame}
...
\begin{frame}{問9(2)　解答}
  ...
  $\mathcal{F}^{-1}[-2\pi iu\,e^{-u^{2}}] = (-i)\cdot\dfrac{1}{2\pi}\cdot2\pi\cdot\dfrac{ix}{2}\sqrt{\pi}\,e^{-x^{2}/4} = \dfrac{\sqrt{\pi}}{2}\,x\,e^{-x^{2}/4}$\\[6pt]
  よって $e^{-x^{2}/2}*xe^{-x^{2}/2} = \dfrac{\sqrt{\pi}}{2}\,xe^{-x^{2}/4}$
  \\[6pt]\hfill 証明終
\end{frame}
