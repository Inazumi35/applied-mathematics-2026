...
\begin{frame}{問6　解答}
  ...
  \begin{itemize}\setlength{\itemsep}{2pt}
    \item $(1) l=1: c_{n} = (1/2)\int_{0}^1 e^{-in\pi x} dx = (1/2)[e^{-in\pi x}/(-in\pi)]_{0}^1$
    \item $    n \neq 0: c_{n} = (1-e^{-in\pi})/(2in\pi) = (1-(-1)^n)/(2in\pi)$
    \item $    n = 0: c_{0} = (1/2)\int_{0}^1 dx = 1/2$
    \item $(2) l=1: c_{n} = (1/2)\int_{0}^1 x e^{-in\pi x} dx$
    \item n \neq 0: 分部積分 $ \to c_{n} = i(-1)^n/(2n\pi) + ((-1)^n - 1)/(2n^{2}\pi^{2})$
    \item $    n = 0: c_{0} = (1/2)\int_{0}^1 x dx = 1/4$
  \end{itemize}
  \end{block}
...
\begin{frame}{問7　解答}
  \begin{block}{}
  \begin{itemize}\setlength{\itemsep}{2pt}
    \item $(1) l=2: c_{n} = (1/4)\int_{-2}^{0} 2 e^{-in\pi x/2} dx$
    \item $    n \neq 0: c_{n} = (1/2)[e^{-in\pi x/2}/(-in\pi/2)]_{-2}^{0} = (1-e^{in\pi})/(in\pi) = (1-(-1)^n)/(in\pi)$
    \item $    n = 0: c_{0} = (1/4)\int_{-2}^{0}2dx = 1$
    \item $(2) l=2: c_{n} = (1/4)\int_{0}^2 (2-x)e^{-in\pi x/2}dx$
    \item n \neq 0: 分部積分 $ \to c_{n} = (1-e^{-in\pi})/(in\pi) + (e^{-in\pi}-1)/(n^{2}\pi^{2}/2)$
    \item $    = (1-(-1)^n)/(in\pi) + 2((-1)^n-1)/(n^{2}\pi^{2})$
    \item $    n = 0: c_{0} = (1/4)\int_{0}^2(2-x)dx = (1/4)[2x-x^{2}/2]_{0}^2 = 1/2$
  \end{itemize}
  \end{block}
  \begin{exampleblock}{答え}
