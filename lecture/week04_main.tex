...
\begin{frame}{例題12　解答}
  ...
  \medskip\textbf{答}：$(1) e^{\alpha t},\ (2) t e^{\alpha t},\ (3) (e^{\alpha t}-e^{\beta t})/(\alpha-\beta),\ (4) (1/\beta)e^{\alpha t}\sin(\beta t)$
\end{frame}
...
\begin{frame}{例題13　解答}
  ...
  \medskip\textbf{答}：$(1) (1/2)e^t \sin(2t),\ (2) e^{-2t}\cos(3t)$
\end{frame}
...
\begin{frame}{例題14　解答}
  ...
  \medskip\textbf{答}：$(1) (1/2)e^{-2t} - e^{-3t} + (1/2)e^{-4t},\ (2) -5/3 + (1+2t)e^{-t} + (2/3)e^{3t}$
\end{frame}
